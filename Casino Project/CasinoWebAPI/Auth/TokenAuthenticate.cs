...
namespace CasinoWebAPI.Auth
{
    ...
    public class TokenAuthenticate : ITokenAuthenticate
    {
        ...
        public string GenerateToken(Login login)
        {
            ...
            // Token nøglen
            var tokennoegle = Encoding.ASCII.GetBytes("123456789123456789123456789123456789");
            ...
            SecurityTokenDescriptor tokenDESC = new SecurityTokenDescriptor()
            {
                ...
                Subject = new ClaimsIdentity(new[] { new Claim("id", login.LoginID.ToString()) }),
